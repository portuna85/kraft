...
- 통합 기술 문서: [`docs/improvement_gpt.md`](docs/improvement_gpt.md) (로컬 전용, 아래 [문서 정책](#문서-정책) 참고)
...
프로젝트 Markdown 문서 중에는 README와 [`docs/improvement_gpt.md`](docs/improvement_gpt.md) 두 개만 존재합니다.

- `README.md`: 서비스 소개, 실행, API, 검증, 배포의 시작점
- `docs/improvement_gpt.md`: 상세 설계 결정, OAuth 설정, 운영 노트, 구현 이력, 우선순위별 개선 과제
