...
[04장 4.6절](04-architecture-and-layers.md#46-예외-처리-전략---해결2026-09-09-추가-구현),
...
| 이름 중복 가입 | ✅ **2026-09-10 신규** | `400` `{"detail":"이미 사용중인 이름입니다. name=...", ...}` — `existsByName` DB 조회 |
| 회원가입 비밀번호가 복잡도 요건 미충족(대/소문자·특수문자 중 하나라도 없음) | ✅ **2026-09-10 신규** | `400` `{"detail":"password: 비밀번호는 대문자, 소문자, 특수문자를 각각 1자 이상 포함해야 합니다.", ...}` |
