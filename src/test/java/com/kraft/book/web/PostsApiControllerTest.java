...
@ActiveProfiles("test") // 테스트용 H2 프로파일 적용 (application-test.yml)
...
class PostsApiControllerTest {
    ...
    @Test
    @DisplayName("POST /api/v1/posts → 등록 성공")
    void posts_등록된다() {
        // given
        String title = "타이틀";
        String content = "콘텐츠";
        ...
        assertThat(response.getBody()).isNotNull().isGreaterThan(0L);
    ...
    void Posts_수정된다() throws Exception {
        ...
        String expectedTitle = "업데이트 타이틀";
        String expectedContent = "업데이트 콘텐츠";
