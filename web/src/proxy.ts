...
import { buildCsp, buildCspReportOnly, generateNonce, NONCE_HEADER } from "@/shared/config/csp";
...
export function proxy(request: NextRequest): NextResponse {
  if (request.nextUrl.pathname.startsWith("/ops") && !isOpsRequestAllowed(request)) {
